...
const (
	SomeService_SomeMethod_FullMethodName = "/another_service_name.v1.SomeService/SomeMethod"
)
...
type SomeServiceClient interface {
	SomeMethod(ctx context.Context, in *SomeMethodRequest, opts ...grpc.CallOption) (*SomeMethodResponse, error)
}
...
func (c *someServiceClient) SomeMethod(ctx context.Context, in *SomeMethodRequest, opts ...grpc.CallOption) (*SomeMethodResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SomeMethodResponse)
...
type SomeServiceServer interface {
	SomeMethod(context.Context, *SomeMethodRequest) (*SomeMethodResponse, error)
...
func (UnimplementedSomeServiceServer) SomeMethod(context.Context, *SomeMethodRequest) (*SomeMethodResponse, error) {
...
func _SomeService_SomeMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SomeServiceServer).SomeMethod(ctx, req.(*SomeMethodRequest))
	}
...
var SomeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "another_service_name.v1.SomeService",
	...
	Metadata: "another_service_name.proto",
}
